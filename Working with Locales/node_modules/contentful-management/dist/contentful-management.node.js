...
function createCMAHttpClient(params, plainClient = false) {
  ...
  `${sdkMain}/${"7.3.0"}`, params.application, params.integration, params.feature);
  ...
  return {
    ...
    createUpload: function createUpload(data) {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["upload"].create(httpUpload, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }, data).then(data => wrapUpload(httpUpload, data));
    },
...
const asIterator = (fn, params) => {
  return {
    [Symbol.asyncIterator]() {
      const options = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(params);

      const get = () => fn(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(options));
...
const update = (http, params, rawData, headers) => {
  ...
  const data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
...
const upsert = (http, params, rawData, headers) => {
  const data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(rawData);
...
const update = (http, params, rawData, headers) => {
  ...
  const data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_3___default()(rawData);
  delete data.sys;
...
const createFromFiles = httpUpload => (http, params, data) => {
...
const create = (http, params, rawData) => {
  const data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, getBaseUrl(params), data);
};
const createWithId = (http, params, rawData) => {
  const data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
...
const create = (http, params, data) => {
  ...
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, `/spaces/${params.spaceId}/environments/${params.environmentId}/uploads`, file, {
    headers: {
...
const del = (http, params) => {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, `/spaces/${params.spaceId}/environments/${params.environmentId}/uploads/${params.uploadId}`);
};
const get = (http, params) => {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, `/spaces/${params.spaceId}/environments/${params.environmentId}/uploads/${params.uploadId}`);
};
...
const createPlainClient = (params, defaults) => {
  ...
  const httpUpload = Object(_create_cma_http_client__WEBPACK_IMPORTED_MODULE_0__["createCMAHttpClient"])(_objectSpread(_objectSpread({}, params), {}, {
