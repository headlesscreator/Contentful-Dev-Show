...
function createCMAHttpClient(params) {
  ...
  "".concat(sdkMain, "/").concat("7.3.0"), params.application, params.integration, params.feature);
  var requiredHeaders = {
    'Content-Type': 'application/vnd.contentful.management.v1+json',
    'X-Contentful-User-Agent': userAgentHeader
  };
  params = _objectSpread(_objectSpread({}, defaultHostParameters), lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_2___default()(params));
...
function createClientApi(_ref) {
  ...
  return {
    ...
    getSpaces: function getSpaces() {
      ...
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_3__["space"].getMany(http, Object(contentful_sdk_core__WEBPACK_IMPORTED_MODULE_0__["createRequestConfig"])({
        query: query
      })).then(function (data) {
...
function createEnvironmentApi(_ref) {
  ...
  return {
    ...
    createAssetFromFiles: function createAssetFromFiles(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["asset"].createFromFiles(httpUpload)(http, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }, data).then(function (data) {
        return wrapAsset(http, data);
    ...
    getUpload: function getUpload(id) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["upload"].get(httpUpload, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id,
        uploadId: id
      }).then(function (data) {
        return wrapUpload(httpUpload, data);
      });
    },
    ...
    createUpload: function createUpload(data) {
      var raw = this.toPlainObject();
      return _plain_endpoints__WEBPACK_IMPORTED_MODULE_2__["upload"].create(httpUpload, {
        spaceId: raw.sys.space.sys.id,
        environmentId: raw.sys.id
      }, data).then(function (data) {
        return wrapUpload(httpUpload, data);
...
var asIterator = function asIterator(fn, params) {
  return _defineProperty({}, Symbol.asyncIterator, function () {
    var options = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(params);

    var get = function get() {
      return fn(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(options));
    };
              ...
              switch (_context.prev = _context.next) {
                ...
                case 9:
                  ...
                  if (endOfPage && !endOfList) {
                    lodash_merge__WEBPACK_IMPORTED_MODULE_1___default()(options, {
                      query: {
                        skip: skip + limit
                      }
                    });
...
var update = function update(http, params, rawData, headers) {
  ...
  var data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(http, params, rawData, headers) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(rawData);
            delete data.sys;
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_1__["get"](http, getAppInstallationUrl(params), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_2__["normalizeSelect"])(params.query)
  });
};
var getMany = function getMany(http, params) {
...
var upsert = function upsert(http, params, rawData, headers) {
  var data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(rawData);

  return _raw__WEBPACK_IMPORTED_MODULE_1__["put"](http, getAppInstallationUrl(params), data, _objectSpread({}, headers));
};
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_1__["del"](http, getAppInstallationUrl(params));
};
...
var update = function update(http, params, rawData, headers) {
  ...
  var data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_3___default()(rawData);
  delete data.sys;
...
var createFromFiles = function createFromFiles(httpUpload) {
  return function (http, params, data) {
...
var create = function create(http, params, rawData) {
  var data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, getBaseUrl(params), data);
};
var createWithId = function createWithId(http, params, rawData) {
  var data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_2___default()(rawData);
...
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_1__["get"](http, getUIExtensionUrl(params), {
    params: Object(_utils__WEBPACK_IMPORTED_MODULE_2__["normalizeSelect"])(params.query)
  });
};
var getMany = function getMany(http, params) {
...
var createWithId = function createWithId(http, params, rawData, headers) {
  ...
  return _raw__WEBPACK_IMPORTED_MODULE_1__["put"](http, getUIExtensionUrl(params), data, {
    headers: headers
  });
};
var update = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(http, params, rawData, headers) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_0___default()(rawData);
            delete data.sys;
            return _context.abrupt("return", _raw__WEBPACK_IMPORTED_MODULE_1__["put"](http, getUIExtensionUrl(params), data, {
              headers: _objectSpread({
                'X-Contentful-Version': (_rawData$sys$version = rawData.sys.version) !== null && _rawData$sys$version !== void 0 ? _rawData$sys$version : 0
              }, headers)
            }));
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_1__["del"](http, getUIExtensionUrl(params));
};
...
var create = function create(http, params, data) {
  ...
  return _raw__WEBPACK_IMPORTED_MODULE_0__["post"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/uploads"), file, {
    headers: {
...
var del = function del(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["del"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/uploads/").concat(params.uploadId));
};
var get = function get(http, params) {
  return _raw__WEBPACK_IMPORTED_MODULE_0__["get"](http, "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/uploads/").concat(params.uploadId));
};
...
var createPlainClient = function createPlainClient(params, defaults) {
  ...
  var httpUpload = Object(_create_cma_http_client__WEBPACK_IMPORTED_MODULE_0__["createCMAHttpClient"])(_objectSpread(_objectSpread({}, params), {}, {
    host: params.hostUpload || _create_cma_http_client__WEBPACK_IMPORTED_MODULE_0__["defaultHostParameters"].defaultHostnameUpload
  }));
  var wrapParams = {
    http: _http,
    defaults: defaults
  ...
  return {
    ...
    asset: {
      ...
      createFromFiles: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])(wrapParams, _endpoints__WEBPACK_IMPORTED_MODULE_1__["asset"].createFromFiles(httpUpload)),
    ...
    upload: {
      get: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])({
        http: httpUpload,
        defaults: defaults
      }, _endpoints__WEBPACK_IMPORTED_MODULE_1__["upload"].get),
      create: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])({
        http: httpUpload,
        defaults: defaults
      }, _endpoints__WEBPACK_IMPORTED_MODULE_1__["upload"].create),
      delete: Object(_wrappers_wrap__WEBPACK_IMPORTED_MODULE_2__["wrap"])({
        http: httpUpload,
        defaults: defaults
      }, _endpoints__WEBPACK_IMPORTED_MODULE_1__["upload"].del)
    },
    locale: {
