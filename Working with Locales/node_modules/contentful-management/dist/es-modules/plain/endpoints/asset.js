...
export var createFromFiles = function createFromFiles(httpUpload) {
...
export function processForLocale(http, params, asset, locale) {
...
export function processForAllLocales(http, params, asset) {
