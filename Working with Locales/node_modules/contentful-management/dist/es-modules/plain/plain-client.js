...
import { createCMAHttpClient, defaultHostParameters } from '../create-cma-http-client';
...
export var createPlainClient = function createPlainClient(params, defaults) {
  ...
  var httpUpload = createCMAHttpClient(_objectSpread(_objectSpread({}, params), {}, {
  ...
  return {
    ...
    upload: {
      get: wrap({
        http: httpUpload,
        defaults: defaults
      }, endpoints.upload.get),
      create: wrap({
        http: httpUpload,
        defaults: defaults
      }, endpoints.upload.create),
      "delete": wrap({
        http: httpUpload,
        defaults: defaults
      }, endpoints.upload.del)
    },
    locale: {
