...
export default function createClientApi(_ref) {
  ...
  return {
    ...
    getSpaces: function getSpaces() {
      ...
      return endpoints.space.getMany(http, createRequestConfig({
        query: query
      })).then(function (data) {
    ...
    getSpace: function getSpace(spaceId) {
      return endpoints.space.get(http, {
        spaceId: spaceId
      }).then(function (data) {
    ...
    createSpace: function createSpace(spaceData, organizationId) {
      return endpoints.space.create(http, {
    ...
    getOrganization: function getOrganization(id) {
      return endpoints.organization.get(http, {
        organizationId: id
      }).then(function (data) {
    ...
    getOrganizations: function getOrganizations() {
      return endpoints.organization.getAll(http).then(function (data) {
    ...
    createPersonalAccessToken: function createPersonalAccessToken(data) {
      return endpoints.personalAccessToken.create(http, data).then(function (response) {
    ...
    getPersonalAccessToken: function getPersonalAccessToken(tokenId) {
      return endpoints.personalAccessToken.get(http, {
        tokenId: tokenId
      }).then(function (data) {
    ...
    getPersonalAccessTokens: function getPersonalAccessTokens() {
      return endpoints.personalAccessToken.getMany(http, {}).then(function (data) {
    ...
    getOrganizationUsage: function getOrganizationUsage(organizationId) {
      ...
      return endpoints.usage.getManyForOrganization(http, {
        organizationId: organizationId,
        query: query
      }).then(function (data) {
    ...
    getSpaceUsage: function getSpaceUsage(organizationId) {
      var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return endpoints.usage.getManyForSpace(http, {
        organizationId: organizationId,
        query: query
      }).then(function (data) {
        return wrapUsageCollection(http, data);
