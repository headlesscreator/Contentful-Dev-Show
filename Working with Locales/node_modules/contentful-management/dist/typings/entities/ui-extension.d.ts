...
declare type UIExtensionSysProps = BasicMetaSysProps & {
    space: SysLink;
    environment: SysLink;
    srcdocSha256?: string;
};
...
export declare type CreateUIExtensionProps = RequireExactlyOne<SetRequired<UIExtensionProps['extension'], 'name' | 'fieldTypes' | 'sidebar'>, 'src' | 'srcdoc'>;
