 ...
 */
export declare function wrapRole(http: AxiosInstance, data: RoleProps): Role;
/**
 * @private
 */
export declare const wrapRoleCollection: (http: AxiosInstance, data: import("../common-types").CollectionProp<RoleProps>) => import("../common-types").Collection<Role, RoleProps>;
export {};
