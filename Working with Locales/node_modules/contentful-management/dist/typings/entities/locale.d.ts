 ...
 * @private
 */
export declare const wrapLocaleCollection: (http: AxiosInstance, data: import("../common-types").CollectionProp<LocaleProps>) => import("../common-types").Collection<Locale, LocaleProps>;
