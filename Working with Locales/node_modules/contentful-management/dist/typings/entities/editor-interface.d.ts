 ...
 * @private
 */
export declare const wrapEditorInterfaceCollection: (http: AxiosInstance, data: import("../common-types").CollectionProp<EditorInterfaceProps>) => import("../common-types").Collection<EditorInterface, EditorInterfaceProps>;
