 ...
 */
export declare function wrapOrganizationMembership(http: AxiosInstance, data: OrganizationMembershipProps, organizationId: string): OrganizationMembership;
/**
 * @private
 */
export declare const wrapOrganizationMembershipCollection: (http: AxiosInstance, data: import("../common-types").CollectionProp<OrganizationMembershipProps>, organizationId: string) => import("../common-types").Collection<OrganizationMembership, OrganizationMembershipProps>;
