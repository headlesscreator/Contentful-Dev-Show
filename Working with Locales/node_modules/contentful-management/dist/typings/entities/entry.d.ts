 ...
 */
export declare function wrapEntry(http: AxiosInstance, data: EntryProps): Entry;
/**
 * Data is also mixed in with link getters if links exist and includes were requested
 * @private
 */
export declare const wrapEntryCollection: (http: AxiosInstance, data: import("../common-types").CollectionProp<EntryProps<Record<string, any>>>) => Collection<Entry, EntryProps<Record<string, any>>>;
export {};
