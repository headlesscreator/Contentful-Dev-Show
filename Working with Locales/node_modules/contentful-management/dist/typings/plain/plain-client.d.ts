...
export declare const createPlainClient: (params: ClientParams, defaults?: DefaultParams | undefined) => {
    ...
    upload: {
        get: (params: Pick<import("./endpoints/common-types").GetSpaceEnvironmentParams & {
            uploadId: string;
        }, "uploadId"> & Partial<Pick<import("./endpoints/common-types").GetSpaceEnvironmentParams & {
            uploadId: string;
        }, "spaceId" | "environmentId">>) => Promise<any>;
        create: (params: Pick<import("./endpoints/common-types").GetSpaceEnvironmentParams, never> & Partial<Pick<import("./endpoints/common-types").GetSpaceEnvironmentParams, "spaceId" | "environmentId">>, data: {
    ...
    locale: {
        ...
        }, headers?: Record<string, unknown> | undefined) => Promise<import("../export-types").LocaleProps>;
    };
    personalAccessToken: {
        get: (params: Pick<{
            tokenId: string;
    ...
    spaceMembership: {
        ...
        create: (params: Pick<import("./endpoints/common-types").GetSpaceParams, never> & Partial<Pick<import("./endpoints/common-types").GetSpaceParams, "spaceId">>, data: Pick<import("../export-types").SpaceMembershipProps, "name" | "admin" | "roles">, headers?: Record<string, unknown> | undefined) => Promise<import("../export-types").SpaceMembershipProps>;
        createWithId: (params: Pick<import("./endpoints/common-types").GetSpaceParams & {
            spaceMembershipId: string;
        }, "spaceMembershipId"> & Partial<Pick<import("./endpoints/common-types").GetSpaceParams & {
            spaceMembershipId: string;
        }, "spaceId">>, data: Pick<import("../export-types").SpaceMembershipProps, "name" | "admin" | "roles">, headers?: Record<string, unknown> | undefined) => Promise<import("../export-types").SpaceMembershipProps>;
        update: (params: Pick<import("./endpoints/common-types").GetSpaceParams & {
            spaceMembershipId: string;
        }, "spaceMembershipId"> & Partial<Pick<import("./endpoints/common-types").GetSpaceParams & {
            spaceMembershipId: string;
    ...
    teamMembership: {
        ...
        getManyForTeam: (params: Pick<import("./endpoints/common-types").GetTeamParams & import("./endpoints/common-types").QueryParams, "teamId" | "query"> & Partial<Pick<import("./endpoints/common-types").GetTeamParams & import("./endpoints/common-types").QueryParams, "organizationId">>) => Promise<import("../common-types").CollectionProp<import("../export-types").TeamMembershipProps>>;
    ...
    teamSpaceMembership: {
        ...
        }, "teamId" | "query"> & Partial<Pick<import("./endpoints/common-types").GetOrganizationParams & import("./endpoints/common-types").QueryParams & {
            teamId?: string | undefined;
